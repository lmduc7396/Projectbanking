...
try:
    ...
    if os.path.exists(comments_file):
        ...
        if len(df) > 0:
            ...
            print(f"\n[READY] Comments database is ready for use!")
        else:
            print("\n[WARNING] Comments file exists but is empty")
    else:
        print("[ERROR] No comments file found")
