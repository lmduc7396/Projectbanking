...
st.set_page_config(
    page_title="Duc Chatbot v2 (Chart Test)",
    layout="wide"
)
...
def main():
    st.title("Duc - AI Chatbot v2 (Chart Test)")
    st.markdown("Only banking related questions are supported. **Testing chart generation feature.**")
